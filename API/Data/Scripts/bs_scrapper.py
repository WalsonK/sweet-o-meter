...
for i in range(1, 289):
    link = f"https://www.shutterstock.com/fr/search/cotton-candy?image_type=photo&page={i}"
...
for i, image_l in enumerate(images_links):
    try:
        ...
        with open(os.path.join("../Datasets/Originals/Cotton_candy/Train", f"image_{i + 16301}.jpg"), "wb") as f:
